...
const InputContainer: React.FC<Props> = ({ onSend }) => {
  ...
  return (
    <div className="fixed inset-x-0 md:bottom-1 bottom-2">
        ...
        <form onSubmit={handleSubmit}>
          <div className="bg-neutral-800 rounded-lg border border-white/20 p-2">
            <textarea
              ...
              placeholder="Message..."
              rows={3}
              className="w-full bg-neutral-800 py-1 px-1.5 text-white text-sm focus:outline-none resize-none placeholder:text-white/50 mb-1 overflow-y-auto max-h-40 no-scrollbar"
