...
export default function UserMessage ({ text, isCopied, onCopy }: Props){
  return (
    <div className="flex flex-col gap-2 justify-end items-end group">
      ...
      <button
        onClick={onCopy}
        className="mr-2 p-1 text-[#1c1c1c]/80 hover:bg-[#10010180] active:bg-[#e9e9e980] rounded-full opacity-0 group-hover:opacity-100 group-active:opacity-100 transition-opacity"
