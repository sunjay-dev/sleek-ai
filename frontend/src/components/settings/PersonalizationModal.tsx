...
export default function PersonalizationSettings() {
  ...
  return (
    <>
      <div id="personalizationModal" className="overflow-y-auto space-y-5 p-4 md:px-6">
        <div className="mb-6">
        ...
        <section>
          ...
          <div className="space-y-3">
            ...
            <div className="flex items-center justify-between p-2.5 border border-gray-500/20 rounded-lg bg-[#fbfbfb] mb-6">
              <div>
