...
export default function SettingsSidebar({ activeTab, setActiveTab, onClose }: Props) {
  ...
  return (
    <aside className="w-full md:w-48 border-b md:border-b-0 md:border-r border-secondary bg-primary p-3 flex flex-col gap-1 shrink-0 h-auto md:overflow-y-auto">
