...
export default function SettingsSidebar({ activeTab, setActiveTab, onClose }: Props) {
  ...
  return (
    <aside className="w-full md:w-43 border-b-[1.3px] md:border-b-0 md:border-r border-gray-500/20 bg-[#fcfbfb] p-3 flex flex-col gap-1 shrink-0 h-auto md:overflow-y-auto">
