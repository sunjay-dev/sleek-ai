...
export const searchUploadedDocuments = tool(
  ...
  },
  {
    ...
    description:
      "Search the uploaded documents within the current chat for specific information or context. Use this tool whenever the user asks about the content of their uploaded files, PDFs, presentations, or documents.",
